-- Fixed version - Make user 041a2635-d615-4579-9b1f-a7dd49cc2a66 an admin

-- Step 1: Create the function to set user role (fixed parameter name)
CREATE OR REPLACE FUNCTION set_user_role(user_id UUID, user_role TEXT)
RETURNS void AS $$
BEGIN
  UPDATE auth.users 
